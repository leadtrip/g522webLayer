            ...
            <section class="row">
                <div id="create-person" class="col-12 content scaffold-create" role="main">
                    ...
                    <g:form resource="${this.person}" method="POST">
                        <fieldset class="form">
                            <f:all bean="person" except="dateOfBirth,homeAddress"/>
                            <div class="fieldcontain required">
                                <label for="dateOfBirth">Date of birth *</label>
                                <g:datePicker name="dateOfBirth" precision="day" />
                            </div>
                            <div class="fieldcontain required">
                                <label for="homeAddress.addressLine1">Address line 1 *</label>
                                <g:textField name="homeAddress.addressLine1" value="${person?.homeAddress?.addressLine1}" />
                            </div>
                            <div class="fieldcontain">
                                <label for="homeAddress.addressLine2">Address line 2</label>
                                <g:textField name="homeAddress.addressLine2" value="${person?.homeAddress?.addressLine2}" />
                            </div>
                        </fieldset>
