...
import wood.mike.PersonService

import static org.springframework.http.HttpStatus.*

/**
 * This controller was generated with create-controller command which also generates a data service
 * The create.gsp is partially auto generated and partially manually created
 * Grails can't create UI fields for LocalDate domain fields and I put the whole address input on the same view
 * rather than use a dropdown which is what grails creates
 */
